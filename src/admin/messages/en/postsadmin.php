...
// 2.1.0
    ...
    'article_autopost_config_empty_token: {id}' => 'Autopost configuration with id {id} has empty access token. You must renew the access token for a valid one to use the autopost function',
